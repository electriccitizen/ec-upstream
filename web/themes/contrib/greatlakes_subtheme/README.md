...
```bash
php web/core/scripts/drupal generate-theme --starterkit greatlakes_subtheme my_custom_theme --path themes/dripyard_themes
```

You can safely ignore the `The source theme greatlakes_subtheme does not have a version specified.` notice as we will not be running this again once your custom theme is created.
...
```bash
greatlakes=neonbyte php web/core/scripts/drupal generate-theme --starterkit greatlakes_subtheme my_custom_theme --path themes/dripyard_themes
```

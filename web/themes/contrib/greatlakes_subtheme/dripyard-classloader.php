...
/**
 * @file
 * Optimized autoloader for the GREATLAKES_SUBTHEME.
 *
...
namespace {
  ...
  if (!defined('GREATLAKES_SUBTHEME_AUTOLOADER_LOADED')) {
    define('GREATLAKES_SUBTHEME_AUTOLOADER_LOADED', TRUE);


    // Register the GREATLAKES_SUBTHEME autoloader.
    spl_autoload_register(function ($class) {
      $prefix = 'Drupal\\GreatlakesSubtheme\\';
